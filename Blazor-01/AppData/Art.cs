    ...
    public class MyArts
    {
        ...
        { 
          ...
          new Art()
          {
              ...
              Title = "Portal<br />To The<br />Past",
              SubTitle = "Sticky Note - Art",
          ...
          new Art()
          {
              ...
              Title = "Find Positive<br />In Everything",
              SubTitle = "Sticky Note - Art",
          ...
          new Art()
          {
              ...
              Title = "Cat<br />In The<br />Coffee Mug",
              SubTitle = "Sticky Note - Art",
          ...
          new Art()
          {
              ...
              Title = "Tree House",
              SubTitle = "Sticky Note - Art",
              IMG = "/images/MyArts/Tree-House.avif",
              VIDEO = "",
          ...
          new Art()
          {
              ...
              Title = "Above Earth",
              SubTitle = "Sticky Note - Art",
              IMG = "/images/MyArts/Above-Earth.avif",
              VIDEO = "",
          ...
          new Art()
          {
              ...
              Title = "Fulgent-Life",
              SubTitle = "Sticky Note - Art",
              IMG = "/images/MyArts/Fulgent-Life.avif",
              VIDEO = "",
          ...
          new Art()
          {
              ...
              SubTitle = "Sticky Note - Art",
              IMG = "/images/MyArts/Nature-Excavation.avif",
              VIDEO = "",
          ...
          new Art()
          {
              ...
              SubTitle = "Sticky Note - Art",
              IMG = "/images/MyArts/Long-Distance-Relationships.avif",
              VIDEO = "",
          ...
          new Art()
          {
              ...
              SubTitle = "Sticky Note - Art",
              IMG = "/images/MyArts/The-Rose-Enchanted.avif",
              VIDEO = "",
          ...
          new Art()
          {
              ...
              SubTitle = "Sticky Note - Art",
              IMG = "/images/MyArts/The-Thorny-Beauty.avif",
              VIDEO = "",
          ...
          new Art()
          {
              ...
              Title = "Beach Beauty",
              SubTitle = "Sticky Note - Art",
              IMG = "/images/MyArts/Beach-Beauty.avif",
              VIDEO = "",
          ...
          new Art()
          {
              ...
              SubTitle = "Sticky Note - Art",
              IMG = "/images/MyArts/Big-Bang-Theory.avif",
              VIDEO = "",
          ...
          new Art()
          {
              ...
              Title = "Isabella",
              SubTitle = "Sticky Note - Art",
              IMG = "/images/MyArts/Isabella.avif",
              VIDEO = "",
          ...
          new Art()
          {
              ...
              Title = "Charlotte",
              SubTitle = "Sticky Note - Art",
              IMG = "/images/MyArts/Charlotte.avif",
              VIDEO = "",
              Desription = "<p class='Art-Detail-Text'>Welcome to the mesmerizing world of sticky note art! In this post, we delve into the captivating drawing of Charlotte, a girl who has a very beautiful smile & her big eyes always attract people.</p><p class='Art-Detail-Text'>Charlotte's eyes sparkle with a depth that captivates the viewer, inviting them into her world. Her smile radiates warmth and joy, leaving a lasting impression on all who encounter her delicate portrait.\n</p><p class='Art-Detail-Text'>Visit [<a class='L-C' href='/MyWorkFlow-MyArtfulness'>MORE</a>] to step into a world where creativity dances with imagination. Where colors come alive. Art whispers its secrets.</p><p class='Art-Detail-Text'>Visit [<a class='L-C' href='https://opensea.io/KhizoOo_'>MORE</a>] to visit my OpenSea account.\n</p>",
              Type = "Art",
              Category = "Sticky Note",
          ...
          new Art()
          {
              ...
              SubTitle = "Sticky Note - Art",
              IMG = "/images/MyArts/Little-Princess.avif",
              VIDEO = "",
              Desription = "<p class='Art-Detail-Text'>Welcome to the world of sticky note art, I want to introduce you to one of my favorite creations. A charming little princess character that has captured the hearts of many.</p><p class='Art-Detail-Text'>Meet the Little Princess, a delightful character brought to life on a small sticky note canvas. With her flowing gown, twinkling eyes, and a crown perched upon her head, she exudes an air of grace and innocence.\n</p><p class='Art-Detail-Text'>Visit [<a class='L-C' href='/MyWorkFlow-MyArtfulness'>MORE</a>] to step into a world where creativity dances with imagination. Where colors come alive. Art whispers its secrets.</p><p class='Art-Detail-Text'>Visit [<a class='L-C' href='https://opensea.io/KhizoOo_'>MORE</a>] to visit my OpenSea account.\n</p>",
              Type = "Art",
              Category = "Sticky Note",
          ...
          new Art()
          {
              ...
              SubTitle = "Sticky Note - Art",
              IMG = "/images/MyArts/Unveiling-Beauty.avif",
              VIDEO = "",
          ...
          new Art()
          {
              ...
              SubTitle = "Sticky Note - Art",
              IMG = "/images/MyArts/Little-Professor.avif",
              VIDEO = "",
